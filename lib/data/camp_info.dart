...
const List<CampDay> kCampDays = [
  ...
  CampDay(
    ...
    rundown: [
      RundownItem(
        time: '09:00–12:20',
        title: '同工晨間流程', titleEn: 'Staff Morning Schedule',
        place: '教會 → 石小', placeEn: 'Church → Shimen ES',
        details: [
          '【同工】09:00 同工集合',
          '【造就】09:00–10:00 造就',
          '【營長】10:00–10:30 營長時間',
          ...
          '11:40 出發石小',
          '【同工】12:00 石小集合',
          '【輔導】到石小後去各小組場地整理，整理完回禮堂禱告',
          '【生活】到石小後去各川堂場地整理，整理完回禮堂禱告',
          '【其它同工】回禮堂開始禱告',
          '【大會】禱告一直到 12:20',
        ],
      ),
      RundownItem(
        ...
        details: [
          '【輔導】報到時段 8 人在一樓指引路線到禮堂',
          '【生活】鳳熒姐引導走錯地點的學生與家長（@教會）；門口放角錐（車導）；A 棟報到處放長桌 2–3 張（教會的）',
          '【生活】備一箱瓶裝礦泉水（學員不配發飲水，鼓勵自帶水壺／備水龍頭礦泉水）；報到：點名單＆手冊、名牌＋感應卡片 → 總採',
      ...
      RundownItem(
        ...
        details: [
          '【主持】帶隊回教會',
          '【輔導】管秩序',
          '【生活】路口指揮（美國路／圓環）、沿途車導；下雨找教會弟兄姊妹開車接送（巡迴遊艇）',
        ],
