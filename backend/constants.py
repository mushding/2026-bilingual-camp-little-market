...
# 積分兌換牌價 tier -> points（倍率 1.0/1.2/1.25/1.33/1.33/1.33）
TIER_MAP = {100: 100, 250: 300, 400: 500, 750: 1000, 1500: 2000, 3000: 4000}
...
# 賭場桌限
BET_MIN, BET_MAX = 10, None  # v2.18 上限取消（None=無上限；v2.11 曾 100→500）
